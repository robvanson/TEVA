...
for file in $(ls -1 ${@:-*.html}); do
	...
	if [[ "${file}" == "Example_evaluating_AST.html" ]]; then
		perl -i'' -ne 's!(\Q<b><i>   </i></b>\E)\s*</p>!</p> <p align=center>\n<a href="Speaker_screenshot.png" target="_blank"><img width="25%" src="Speaker_screenshot.png" VSPACE=10></a></p>\n!g;print $_' \
			${file}
		perl -i'' -ne 's!(\Q<b><i>    </i></b>\E)\s*</p>\s*$!</p> <p align=center>\n<a href="SpeakerInfo_screenshot.png" target="_blank"><img width="50%" src="SpeakerInfo_screenshot.png" VSPACE=10></a></p>\n!g;print $_' \
			${file}
	fi
done
